...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const player = AudioPlayer.getInstance(
    ...
    ["Mele Kalikimaka.mp3", "Mr Grinch.mp3", "Rudolph.mp3", 
      ...
      "Rudy the Red Nosed Reindeer.mp3", "A Charlie Brown Christmas.mp3", "Santa Baby.mp3", "Welcome Christmas.mp3"],  // these songs will always be last
    ["All I Want For Christmas Is You.mp3", "Wonderful Christmastime.mp3"] // these songs will always be first
    );
